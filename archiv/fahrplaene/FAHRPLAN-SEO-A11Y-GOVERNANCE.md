# ARCHIV — ausgelagerte Abschnitte aus `fahrplaene/FAHRPLAN-SEO-A11Y-GOVERNANCE.md`
...
- **`archiv/FAHRPLAN-RECHTSSAMMLUNG.md` / `GESETZE-IMPORT-3TIER.md`:** liefern den `status`-/`snapshot`-Begriff, auf dem W1.5 (Thin-Content-Filter) aufsetzt — referenzieren, nicht neu definieren.
