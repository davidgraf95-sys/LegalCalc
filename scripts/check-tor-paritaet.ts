...
const ALLOWLIST: Record<string, string> = {
  ...
  'check:lizenzen': 'neu (QS-VERWENDEN V1, 2.9.2026) — ci.yml war für diesen Bau-Auftrag TABU (baut eine andere Einheit); Verdrahtung in den PR-Pfad ist ein eigener, nachgelagerter Schritt (Folgeschritt QS-VERWENDEN V1b: check:lizenzen im Tore-Job von ci.yml verdrahten, eigener PR, Absprache 2.9.2026). Bis dahin lokal in check:seriell/gate vor jedem Deploy.',
};
