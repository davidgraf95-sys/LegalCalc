...
const ALLOWLIST: Record<string, string> = {
  ...
  'check:lizenzen': 'neu (QS-VERWENDEN V1, 2.9.2026) — ci.yml war für diesen Bau-Auftrag TABU (baut eine andere Einheit); Verdrahtung in den PR-Pfad ist ein eigener, nachgelagerter Schritt. Bis dahin lokal in check:seriell/gate vor jedem Deploy.',
};
