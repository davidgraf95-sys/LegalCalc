...
// T2/S2 + Identitäts-Split: R8.3 (1.9.2026) wortgleich nach erlass-identitaet.ts
// verschoben (Zyklus-Auflösung check:zyklen: kanton-abk-roh.ts brauchte beide
// Funktionen, browse-manifest importiert seinerseits kanton-abk-roh). Re-Export
// hält Bestands-Importe (Tests, normtext-snapshot) unverändert (§6).
export { istKuerzelFragment, identitaetAusErlass } from './erlass-identitaet.ts';
import { identitaetAusErlass } from './erlass-identitaet.ts';
