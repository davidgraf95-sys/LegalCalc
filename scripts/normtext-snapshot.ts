...
// R8.3 (1.9.2026): erlassBezeichnung/akronymAusErlassName wortgleich nach
// scripts/normtext/erlass-bezeichnung.ts verschoben — diese Datei führt beim
// Import ausserhalb von vitest main() aus und war damit für den Rohfeld-
// Generator (Round-Trip-Beweis) nicht importierbar. Re-Export hält bestehende
// Importe/Tests unverändert (§6).
export { erlassBezeichnung, akronymAusErlassName } from './normtext/erlass-bezeichnung.ts';
import { erlassBezeichnung, akronymAusErlassName } from './normtext/erlass-bezeichnung.ts';
