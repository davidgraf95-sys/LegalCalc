...
- **Säuberungs-PR #___** `feat/leser-v3-saeuberung-nachzug` (Live-Ästhetik 8/10 → **8,5/10**): 18 Ä-Zeilen Benennung/Doppelungen, Benennungs-Glossar als bewachte Wahrheit (Design-Grundlage Kap. 11); drei Prüfer → **Ä126** (Such-Platzhalter 465 px in 280-px-Feld, Genus falsch) und **P3-1** (§8-Satz ignorierte den Erfassungsgrad) vor Merge behoben, acht Nachzüge im selben PR.
