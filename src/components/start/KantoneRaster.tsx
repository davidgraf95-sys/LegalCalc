...
export function KantoneRaster() {
  ...
  return (
    <StartZeile reg="g" ueber="Kantonsrecht"
      rand={<>{nf(z.gesetzeKantonVolltext)} Erlasse<br />im Volltext</>}
      titel="Kantone, erfasste Erlasse">
      ...
      <StartFuss>
        Die Zahl ist der Umfang unserer Erfassung, nicht die Grösse der kantonalen Sammlung.
      </StartFuss>
    </StartZeile>
  );
}
