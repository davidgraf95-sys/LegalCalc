...
Signal (§7-Abweichung, kippte echte Steuerfälle). Bestands-Regen 119 Snapshots / 235 Register-Wechsel via
`remap-sachgebiet-j3.ts` (Gegenprüfungs-Befunde F1–F3 eingebaut); Quirks Q-J3-1…6 (Offline-Signalquelle, totes STG, Doppel-Topf
