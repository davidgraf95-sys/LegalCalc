...
| Dokument | Inhalt |
|---|---|
| [kanton-abk-kollisionen-2026-08-31.md](register/kanton-abk-kollisionen-2026-08-31.md) | **R8 Kanton-Kürzel-Aliase — Kollisionsreport** (generiert 31.8.2026, `gen:kanton-abk-aliase -- --report`): 572 amtlich belegte Kanton-Aliase aus dem abbreviation-Feld des Registers (Regel-Herleitung im Generator-Kopf, deterministisch); Bund↔Kanton-Kollisionen 7 (u. a. StG 6×), Kanton↔Kanton 36 — Kollisionen legitim (Kürzel = Alias, nie Schlüssel), Ebenen strikt getrennt. Pflege: bei Register-Zuwachs per `--report` neu erzeugen; Wächter `check:kanton-abk-aliase` hält das Artefakt synchron | Report, Status entwurf |
