...
| Dokument | Inhalt |
|---|---|
| [kanton-abk-kollisionen-2026-08-31.md](register/kanton-abk-kollisionen-2026-08-31.md) | **R8 Kanton-Kürzel-Aliase — Kollisionsreport** (generiert 31.8.2026, `gen:kanton-abk-aliase -- --report`): 569 belegte Kanton-Aliase aus dem kuerzel-Feld des Registers (Regel-Herleitung R1–R7 im Generator-Kopf, deterministisch; beim Erstbau 31.8. waren es 572 — Fix-Runde R8.2 gleichentags entfernte per R6/R7 die drei unbelegten bzw. irreführenden Werte GKV/GebO/«TG», GP-Befunde F1/F2/F5); Bund↔Kanton-Kollisionen 7 (u. a. StG 6×), Kanton↔Kanton 36 — Kollisionen legitim (Kürzel = Alias, nie Schlüssel), Ebenen strikt getrennt. Pflege: bei Register-Zuwachs per `--report` neu erzeugen; Wächter `check:kanton-abk-aliase` hält Artefakt UND Report byte-gleich synchron (F6-Tor) | Report, Status entwurf |
| [kanton-abk-kollisionen-2026-09-01.md](register/kanton-abk-kollisionen-2026-09-01.md) | **R8.3 Kanton-Kürzel-Aliase — Kollisionsreport nach dem F8-Wurzel-Fix** (generiert 1.9.2026, `gen:kanton-abk-aliase -- --report`): 526 belegte Kanton-Aliase, Quelle seit R8.3 das ROHE Registerfeld `abkRoh` (Sidecar `public/normtext/kanton-abk-roh.json`: verbatim API-`abbreviation`, herkunft api/rueckrechnung mit Stand+Quelle; Regeln R2–R7, R1 gestorben). Bilanz gegen 31.8.: −43 live-belegte Titel-Aliase (abbreviation='' per API, u. a. BS-291.100 Advokaturgesetz), Korrektur BS-292.110 NoVo→NotV; 248 gezielte API-Abrufe 1.9.2026 als Beleg. Wächter: `check:kanton-abk-roh` (offline) + `check:kanton-abk-netz` (rotierende Live-Stichprobe n=20). Vorgänger-Report 31.8. bleibt als datierter Beleg stehen (Belege altern nicht) | Report, Status entwurf |
