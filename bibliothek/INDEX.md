...
| [legaldefinitionen-muster-erhebung-2026-08-31.md](normtext/legaldefinitionen-muster-erhebung-2026-08-31.md) | **Legaldefinitions-Muster im Gesamtkorpus** (31.8.2026, R6/W2·13-KANTONE-DATEN): Erhebung über 1 458 Snapshots / 56 113 Artikel — 8 Muster aufgenommen (Präzision je systematischer Stichprobe bzw. Vollerhebung: `als-gilt` 40/40 bei 1 469 Treffern · `legende-einleitung` 20/20 · `guillemets` 75/75 · `kurzform` 20/20 · `im-sinne` 20/20 · `legende-marginalie` 22/22 · `unter-versteht` 13/13 · `bedeutet-begriff` 12/13), **6 Kandidaten mit Zahlen verworfen** (u.a. «bezeichnet» 0/12 — heisst im Erlasstext *ernennen*; «gilt als» nicht invertiert 4/20 — Fiktion statt Begriff; Begriffs-Marginalie + «X ist/sind» 44/51 unter der Schwelle). fr/it nur gezählt (8 Treffer), NICHT aufgenommen — Teilkorpus zu dünn. Nebenbefund: **lit.-Marke ist kein Schlüssel**, 623 Blöcke mit Doppelmarken (HMG Art. 4 sechsmal `a`) | ERSTMESSUNG (systematische Stichproben, zwei versetzte Ziehungen beim grössten Muster); Abnahme David offen |
