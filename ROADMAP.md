...
- [~] **5m-LESER-V3 · Gesetz-Leser V3: Hülle neu, Kern unangetastet** *(Auftrag David 16.8.2026, 19 Positionen; Konzept + Council-Review 16.8.2026)*:
  ...
  - [ ] **V-0 · Klick-Prototyp** — statischer HTML-Prototyp mit echtem StPO-Text, drei Breiten, Variante A (Kopf mit «Ansicht ▾») / B (Kopf ohne Menü, Schalter im Panel-Reiter «Anzeige»); David entscheidet am Bild (**F7**). Kap. 6.
