...
- [ ] **`QS-AUDIT-VERWEISE` · Reglement-Audit 7.8.: Konkordanzen, zwei Tore, Restpunkte** *(Dach-Schritt mit Checkliste seit 8.8.2026 — Entstückelungs-Schnitt der L-Einheit; PR #460; Punkte 1+7, §16/§17, Präambel am 7.8. in QS-SELBSTOPT erledigt; landung-Merge-Politik-Altstand am 8.8. in QS-SKILL-DIAET versöhnt)* — sortenrein checklisten-weise abarbeiten, alles Nicht-Risiko; Punkt 8 der Rangfolge bleibt bei David. **Detail:** [AUDIT-CLAUDE-MD-REGLEMENT-2026-08-07.md](bibliothek/register/AUDIT-CLAUDE-MD-REGLEMENT-2026-08-07.md) § «Massnahmen-Rangfolge».
  - [ ] §15-Konkordanz: ~111 tote §15.x-Unternummern-Verweise lösen im Skill `perf` auf (Muster: `auftrag` Ziff. 9)
  - [ ] §13-Konkordanz: ~12 tote §13.x-Verweise (Ziel: DESIGN-REGLEMENT-Dach)
  - [ ] §12.2-Anker-Kollision auflösen
  - [ ] `fixkosten-audit-t10.md:33` bereinigen (Rest aus Rangfolge-Punkt 2)
  - [ ] §6.3-Diff-Tor bauen (~30 Z., einmal rot zeigen, §6.7)
  - [ ] §3-ESLint-Tor: §2-Muster auf `src/pages`+`src/components` übertragen, Bestand grandfathern, einmal rot zeigen
  - [ ] CLAUDE.md-Zeilen-Budget im struktur-rotieren-Wächter (Drift ist strukturell; Ceiling-Zahl nur im Skript-Kopf)
  - [~] §10-Chesterton-Prüfung: streichen mit Nummern-Sperre (§16-Muster) oder Anlass benennen
  <!-- @meta id: QS-AUDIT-VERWEISE · status: wip · of: ja · blocker: null · dep: [] · kollision: [CLAUDE.md, .claude/skills, fahrplaene, eslint.config.js, .claude/hooks] · worktree: ja · 26x: nein · groesse: L -->
...
> **⬆ OBERSTER OFFENER SCHRITT: `W2·10-UI-NAV`** (Queue-Kopf; Prozess vor Produkt, Entscheid David 8.8.2026; Fokus-Dekret 24.7.2026 unten). `QS-AUDIT-VERWEISE` ist im Bau (wip, Session 8.8.2026, Dach-Checkliste); `QS-SKILL-DIAET` (PR #468) und `QS-CONFIDENCE-EHRLICH` (PR #469) sind am 8.8.2026 gelandet → Chronik.
