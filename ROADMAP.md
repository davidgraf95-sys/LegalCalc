...
- [ ] **18-FEHLERBUCH · Davids Alltags-Fehlerfunde (stehender Sammel-Schritt)** *(Entscheid David 8.8.2026 — Kleinvieh bündeln statt einzeln durch die volle Maschine)*
  ...
  - [ ] **`check:materialien` läuft durch blossen Kalender-Ablauf rot** (Nullprobe-belegt 13.8.2026 auf unverändertem `main`: VERN-2025-100 trägt Status «laufend», `fristEnde` 2026-08-12 lag einen Tag zurück). Ein Vernehmlassungs-Datum, das gestern ablief, macht heute JEDEN PR rot, ohne dass jemand etwas kaputt gemacht hat — das Tor misst Kalenderzeit statt Korrektheit. Wurzel-Fix: abgelaufene Fristen deterministisch als «abgeschlossen» ableiten statt den Status einzufrieren, oder das Tor auf Harvest-Alter statt Fristdatum umstellen. *(Fund beim Torlauf W2·19B-KORPUS; hat dort Zeit gekostet, wird es bei jedem Folge-PR wieder.)*
  - [ ] **`registerStand`-Testanker war ein garantierter Fehlalarm** — er pinnte das Tagesdatum der Register-Stand-Zeile, die das Register selbst bei jeder Pflege zu ändern vorschreibt. Am 13.8.2026 auf Grammatik-Prüfung umgestellt (W2·19B-KORPUS). **Offen: dasselbe Muster anderswo suchen** — ein Test, der einen von Hand gepflegten Tageswert festschreibt, meldet Pflege als Defekt.
