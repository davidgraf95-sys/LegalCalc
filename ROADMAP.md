...
- [ ] **10-UI-NAV · UI-Nutzwert & Navigation (Ultracode-Synthese 11.7.)** *(`[OF]`, reine UI/Navigation)*:
  ...
  - [ ] **Gesetzesübersicht nach Rechtsgebieten (Idee David 16.8.2026, dejure.org «Gesetze nach Rechtsgebieten»)** — `/gesetze`: Erlasse je Rechtsgebiet gruppiert, dichte Spalten mit Kurztiteln als Linkliste; dieselbe Einteilung wie «Nach Sachgebiet» in der Rechtsprechung (SSoT). Reine Übersichtsseite, nach dem Leser-Umbau (W2·5m). Detail: FAHRPLAN-LESER-V3.md Kap. 14.
