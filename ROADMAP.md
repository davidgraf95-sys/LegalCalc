...
> **⬆ OBERSTER OFFENER SCHRITT: `QS-CONFIDENCE-EHRLICH`** (Queue-Kopf; Prozess vor Produkt, Entscheid David 8.8.2026; Fokus-Dekret 24.7.2026 unten). `QS-SKILL-DIAET` ist gelandet (PR #468, 8.8.2026 → Chronik).
