...
- [~] **Kantonale Gesetze — Daten & Extraktion** *(`W2·13-KANTONE-DATEN`, Aufteilung 8.8.2026, sortenrein)*
  <!-- @meta id: W2·13-KANTONE-DATEN · status: wip · blocker: null · dep: [] · feld: korpus · fahrplan: fahrplaene/FAHRPLAN-KANTONE.md -->
  ...
  - [ ] **K-13 · Systematik-Bäume 7 Kantone** *(F6≡F43)* — **ZH erledigt 31.8.2026** (14 amtliche Ordner aus der server-gerenderten Suchseite, `scripts/normtext/zh-systematik.ts` → Generator-Zweig; Zuordnung über das Nummernband, 20/20 gegen den amtlichen JSON-Endpunkt bestätigt). Offen: GE/VD/TI/SZ/NE/JU; Quell-Erhebung je Kanton empirisch und browserlos. §1-A.
  ...
  - [ ] **ZH-4d · §-Segmentierer schluckt Gliederungs-Überschriften** *(Befund 31.8.2026)* — «4. Abschnitt: Medien» u. ä. landet am Ende des VORANGEHENDEN § (129 Blöcke in 16 von 20 ZH-Erlassen); zusätzlich der Loseblatt-Änderungsapparat im letzten § (10 von 2173 Artikeln). Kein Textverlust, aber falsche Zuordnung; in den drei kurzen Bestands-Gebührenverordnungen trat es nie auf. Sollte vor ZH-Stufe 3. §1-A.
  - [ ] **ZH-4e · Art.-Marker-Zweig im ZH-PDF-Adapter** *(Befund 31.8.2026)* — die Kantonsverfassung (LS 101) und weitere Art.-gezählte ZH-Erlasse liefern ohne ihn 0 Paragraphen. Bestands-Snapshots müssen byte-gleich bleiben. §1-A.
