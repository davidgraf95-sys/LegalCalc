...
- [ ] **10-UI-NAV · UI-Nutzwert & Navigation (Ultracode-Synthese 11.7.)** *(`[OF]`, reine UI/Navigation)*:
  ...
  - [~] **UI-NAV-J3 · Sachgebiets-Pipeline verfeinern (J3)** — **bewusst allein**, weil Risiko-Pfad: `QS-GP` Pflicht + golden byte-gleich, eigene Gegenprüfungs-Runde. §6.
    <!-- @meta id: W2·10-UI-NAV-J3 · status: wip · blocker: null · dep: [] · kollision: [scripts/rechtsprechung, public/rechtsprechung/register.json, src/lib/normtext/browse.ts] · worktree: ja · 26x: nein · groesse: M · fahrplan: fahrplaene/FAHRPLAN-UI-NAVIGATION.md -->
...
- [ ] **18-FEHLERBUCH · Davids Alltags-Fehlerfunde (stehender Sammel-Schritt)** *(Entscheid David 8.8.2026 — Kleinvieh bündeln statt einzeln durch die volle Maschine)*
  ...
  - [ ] **Katalog `/gesetze`: vier Suchfelder ohne abgegrenzte Geltungsbereiche** — unklar, welches Feld welchen Treffer-Raum durchsucht. *(Cowork-Befund 18, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
  - [ ] **A–Z-Register startet leer** — halber Bildschirm «Noch nichts gewählt» vor der ersten Eingabe. *(Cowork-Befund 19, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
  - [ ] **Entwicklertexte in Palette/Panel prüfen** — Wortlaut glätten, aber erst klären, was davon deklarierte Ehrlichkeit (§8) ist und bleiben soll. *(Cowork-Befund 33, 18.8.2026, unverifiziert — vor Bau reproduzieren; Plan-Klasse A = mutmasslich Absicht, nur Detail/Wortlaut prüfen.)*
  - [ ] **International-Karten: Metadatenzeile uneinheitlich** — mal Artikelzahl, mal «amtliches PDF». *(Cowork-Befund 47, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
  - [ ] **Eingebettetes PDF ~5 s schwarze Fläche ohne Ladeanzeige.** *(Cowork-Befund 46, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
  - [ ] **FR/IT-Band lässt sich nur durch Aufgeben entfernen, schiebt die Seite 19 px** — Wortlaut/Verhalten prüfen. *(Cowork-Befund 48, 18.8.2026, unverifiziert — vor Bau reproduzieren; Plan-Klasse A = mutmasslich Absicht, nur Detail prüfen.)*
  ...
  - [ ] **Kantonswahl: Karte UND Karte/Liste-Umschalter verschwinden nach der Wahl** — «ZH 3» bricht dabei allein um. *(Cowork-Befund 41, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
  - [ ] **Brotkrume Kantonsebene zu flach, LS-Nummer fehlt.** *(Cowork-Befund 43, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
  - [ ] **Abdeckungs-Einordnung fehlt in der Seitenleiste** — 859 BS/266 AR vs. 1–7 Erlasse bei übrigen Kantonen ohne Einstufung «vollständig/Auswahl/dünn» (§8-nah). *(Cowork-Befund 44, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
  - [ ] **Kantonskarte ohne Legende** — Pastellfarben ohne erklärte Bedeutung, Kantonsnamen erst nach Klick sichtbar. *(Cowork-Befund 49, 18.8.2026, unverifiziert — vor Bau reproduzieren.)*
