...
- [ ] **18-FEHLERBUCH · Davids Alltags-Fehlerfunde (stehender Sammel-Schritt)** *(Entscheid David 8.8.2026 — Kleinvieh bündeln statt einzeln durch die volle Maschine)*
  ...
  - [ ] **Alt-Flake `leser-weiterlesen-r4-r8` (R8 j/k) im Shard-Kontext:** flaky schon vor allen W2·19-Änderungen (Shard 7, Befund 9.8.2026) — gleiche Familie; Wurzel-Fix mit Mandat, Messbedingung protokollieren.
  ...
  - [ ] **Klick-Pfad der Gliederungs-Zeile (Perf-Restposten W2·19):** 161 ms Handler @4× auf OR, OR/BGFA-Verhältnis 7.0→14.6 VERSCHLECHTERT — Kosten hängen am Klickpfad (flushSync/Sprung-Berechnung), nicht am Mount; Messpunkte in der [Nachmessung](bibliothek/betrieb/gliederung-perf-nachmessung-2026-08-09.md). Skill perf, Logikverlust-Bewertung.
  - [ ] **Lese-Kadenz-TBT @4× (U3-Rest):** ~10 s Blockierzeit über 32 s bei realistischem Lesetempo auf 4×-gedrosselten Geräten (Spy-/Zuklapp-/Re-Render-Pfad; @1× unmerklich). Messvorschrift: Kadenz aus der Nachmessungs-Kopfzeile übernehmen — Burst misst diesen Pfad strukturell nicht.
  - [ ] **Liste `/gesetze`: Leerfläche am Seitenende schliessen (LM-163-Alternativerklärung):** ~370 px echte Leere zwischen letzter Rechtsgebiets-Karte und Footer @1440×900 — beim Scroll ans Ende halber Bildschirm leer; Footer/Mindesthöhe des Hauptbereichs prüfen (risikoarm; Beleg: LM-163-Nachprüfung 9.8.2026, Ruhe-Screenshot K1).
