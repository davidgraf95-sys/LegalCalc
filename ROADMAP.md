...
- [x] **`QS-FRIT-DRIFT` · FR/IT-Drift-Wächter Stufe 1 (eId-Mengenvergleich DE/FR/IT)** — gebaut 15.8.2026: `check:frit-drift` vergleicht je 30 Kern-Erlass die eId-Mengen der drei Amtssprachen am gepinnten Stand, im Normen-Monitor verdrahtet. **Erstlauf-Befund:** OR, PatG und BewG weichen in fr/it real ab — ein neu eingeschobener Artikel bekommt dort keinen eigenen eId (Artikel gegenüber eId versetzt) ⇒ **`eId` trägt nicht sprachübergreifend**, Konsequenz für die Zeile «Mehrsprachiger Normvergleich» in `W2·5g-ZEIT`. Dossier: [frit-drift-2026-08-15.md](bibliothek/register/frit-drift-2026-08-15.md). **Detail:** [FAHRPLAN-FEDLEX-PORTFOLIO.md](fahrplaene/FAHRPLAN-FEDLEX-PORTFOLIO.md) §18.1.
  <!-- @meta id: QS-FRIT-DRIFT · status: done · blocker: null · dep: [] · kollision: [.github/workflows/normen-monitor.yml, scripts/fedlex-versionen-pruefen.ts] · worktree: ja · 26x: nein · groesse: M · fahrplan: fahrplaene/FAHRPLAN-FEDLEX-PORTFOLIO.md -->
