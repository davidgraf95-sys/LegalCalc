...
- [ ] **10-UI-NAV · UI-Nutzwert & Navigation (Ultracode-Synthese 11.7.)** *(`[OF]`, reine UI/Navigation)*:
  ...
  Offen ist nur noch **-J3** (-S/-V/-J/-O erledigt 8.8.2026, Wortlaut in `ROADMAP-CHRONIK.md`
  § «Umschichtung 8.8.2026»); `dep`-Korrektur und Diät-Herkunft:
