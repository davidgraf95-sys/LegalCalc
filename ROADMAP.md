...
- [ ] **18-FEHLERBUCH · Davids Alltags-Fehlerfunde (stehender Sammel-Schritt)** *(Entscheid David 8.8.2026 — Kleinvieh bündeln statt einzeln durch die volle Maschine)*
  ...
  - [ ] **37 der 42 zeigen eine LEERE Leiste, keinen Artikel-Index** *(19B-Nachtrag 13.8.)* — T10-Annahme «B2/B3 aus Snapshot-Labels» trägt nicht (Dichte 0 ⇒ `b3-leer`); kollidiert mit Davids Vorgabe «Gliederung bis zum Artikel sichtbar». UI-, kein Korpus-Entscheid.
