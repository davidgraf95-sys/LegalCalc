...
- [~] **LM-155** · Mittel · Acht Einrückungsebenen liegen bei 330, 340, 346, 349, 356, 365, 375 … [Verdacht → FAHRPLAN-GESETZES-UX.md §10.9 Entscheid A28 (Z. 1489-1504, gebaut 12.7.) + U-LINIEN/A8 (Z. 890)…] — **offen, wartet auf David**: Kollision mit David-Entscheid A28 (Gliederungs-Guide korpusweit AUS, 12.7.2026 — „funktioniert überhaupt nicht"). Der Befund verlangt genau die zurückgenommene Tiefen-Führung wieder sichtbar — nicht autonom gebaut (dedup_referenz-Auflage); Kästchen bleibt offen, bis David entscheidet. — **Neubau freigegeben (David 8.8.2026, revidiert seine Verwerfung vom selben Tag; ersetzt die 12.7.-Abschaltung)** → Bau-Position `B4-N1` in ROADMAP.md (W2·17-Checkliste).
